...
export async function POST(req: Request) {
  ...
  if (eventType === 'user.created' || eventType === 'user.updated') {
    ...
    if (clerkId) {
      ...
      const role = (public_metadata?.role as string) || 'GENERATOR';
      ...
      try {
        ...
        console.log(`Successfully synced user ${clerkId} to DB`);
      } catch (error) {
        console.error(`Error syncing user ${clerkId} to DB:`, error);
      }
    }
  }
